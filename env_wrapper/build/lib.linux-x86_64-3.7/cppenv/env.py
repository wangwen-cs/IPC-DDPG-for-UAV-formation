...
class ManyUavEnv(_object):
    ...
    def __init__(self, uav_cnt: 'int', random_seed: 'int', reward_type: 'int'):
        this = _env.new_ManyUavEnv(uav_cnt, random_seed, reward_type)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
class Observation(_object):
    ...
    def __len__(self) -> "std::array< double,22 >::size_type":
        return _env.Observation___len__(self)

    def __getslice__(self, i: 'std::array< double,22 >::difference_type', j: 'std::array< double,22 >::difference_type') -> "std::array< double,22 > *":
        return _env.Observation___getslice__(self, i, j)

    def __setslice__(self, *args) -> "void":
        return _env.Observation___setslice__(self, *args)

    def __delslice__(self, i: 'std::array< double,22 >::difference_type', j: 'std::array< double,22 >::difference_type') -> "void":
        return _env.Observation___delslice__(self, i, j)

    def __delitem__(self, *args) -> "void":
        return _env.Observation___delitem__(self, *args)

    def __getitem__(self, *args) -> "std::array< double,22 >::value_type const &":
    ...
    def size(self) -> "std::array< double,22 >::size_type":
        return _env.Observation_size(self)

    def swap(self, v: 'Observation') -> "void":
        return _env.Observation_swap(self, v)

    def begin(self) -> "std::array< double,22 >::iterator":
        return _env.Observation_begin(self)

    def end(self) -> "std::array< double,22 >::iterator":
        return _env.Observation_end(self)

    def rbegin(self) -> "std::array< double,22 >::reverse_iterator":
        return _env.Observation_rbegin(self)

    def rend(self) -> "std::array< double,22 >::reverse_iterator":
        return _env.Observation_rend(self)

    def front(self) -> "std::array< double,22 >::value_type const &":
        return _env.Observation_front(self)

    def back(self) -> "std::array< double,22 >::value_type const &":
        return _env.Observation_back(self)

    def fill(self, u: 'std::array< double,22 >::value_type const &') -> "void":
...
class Observations(_object):
    ...
    def __len__(self) -> "std::vector< std::array< double,22 > >::size_type":
        return _env.Observations___len__(self)

    def __getslice__(self, i: 'std::vector< std::array< double,22 > >::difference_type', j: 'std::vector< std::array< double,22 > >::difference_type') -> "std::vector< std::array< double,22 >,std::allocator< std::array< double,22 > > > *":
        return _env.Observations___getslice__(self, i, j)

    def __setslice__(self, *args) -> "void":
        return _env.Observations___setslice__(self, *args)

    def __delslice__(self, i: 'std::vector< std::array< double,22 > >::difference_type', j: 'std::vector< std::array< double,22 > >::difference_type') -> "void":
        return _env.Observations___delslice__(self, i, j)

    def __delitem__(self, *args) -> "void":
        return _env.Observations___delitem__(self, *args)

    def __getitem__(self, *args) -> "std::vector< std::array< double,22 > >::value_type const &":
        return _env.Observations___getitem__(self, *args)

    def __setitem__(self, *args) -> "void":
        return _env.Observations___setitem__(self, *args)

    def pop(self) -> "std::vector< std::array< double,22 > >::value_type":
    ...
    def size(self) -> "std::vector< std::array< double,22 > >::size_type":
        return _env.Observations_size(self)

    def swap(self, v: 'Observations') -> "void":
        return _env.Observations_swap(self, v)

    def begin(self) -> "std::vector< std::array< double,22 > >::iterator":
        return _env.Observations_begin(self)

    def end(self) -> "std::vector< std::array< double,22 > >::iterator":
        return _env.Observations_end(self)

    def rbegin(self) -> "std::vector< std::array< double,22 > >::reverse_iterator":
        return _env.Observations_rbegin(self)

    def rend(self) -> "std::vector< std::array< double,22 > >::reverse_iterator":
        return _env.Observations_rend(self)

    def clear(self) -> "void":
        return _env.Observations_clear(self)

    def get_allocator(self) -> "std::vector< std::array< double,22 > >::allocator_type":
        return _env.Observations_get_allocator(self)

    def pop_back(self) -> "void":
        return _env.Observations_pop_back(self)

    def erase(self, *args) -> "std::vector< std::array< double,22 > >::iterator":
    ...
    def front(self) -> "std::vector< std::array< double,22 > >::value_type const &":
        return _env.Observations_front(self)

    def back(self) -> "std::vector< std::array< double,22 > >::value_type const &":
        return _env.Observations_back(self)

    def assign(self, n: 'std::vector< std::array< double,22 > >::size_type', x: 'Observation') -> "void":
    ...
    def reserve(self, n: 'std::vector< std::array< double,22 > >::size_type') -> "void":
        return _env.Observations_reserve(self, n)

    def capacity(self) -> "std::vector< std::array< double,22 > >::size_type":
